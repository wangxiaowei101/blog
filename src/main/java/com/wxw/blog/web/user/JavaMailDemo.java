...
//    public static String sendEmailAccount = "1281443565@qq.com";
//    public static String sendEmailPwd = "taeyjbquqlkvjahj";
//    public static String receiveMailAccount = "1564866653@qq.com";
//    
//    //发件人邮箱服务器地址
//    
...
//     * @throws Exception
//     */
    public static MimeMessage createMimeMessage(Session session1, String sendMail, String receiveMail) throws Exception {
        // 1. 创建一封邮件
        ...
        String verificationCode = String.valueOf((int)((Math.random()*9+1)*1000));//生成随机4位数
