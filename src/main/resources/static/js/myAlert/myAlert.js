function myAlert(str,click,useCancel){
    ...
    var init=function(){
        ...
        var $okBtn = $("<div style='float:left;width:100%;color:#fff;border-radius:2px;padding:7px 0;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;background:#ccc; '  class='bluebg1'>确定</div>")
